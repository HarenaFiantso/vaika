  ...
  return (
    <nav className="absolute left-0 right-0 z-10 w-full border-b bg-transparent p-2 dark:border-b-gray-800">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between px-2 md:px-6">
        ...
        {isDropdownShown && (
          <div
            className="absolute right-8 top-16 z-50 flex min-h-[270px] min-w-[290px]  flex-col gap-2 rounded-lg border bg-white/30 from-slate-700 to-slate-900 px-5 py-6 text-left shadow backdrop-blur-sm md:hidden dark:border-zinc-600 dark:bg-gradient-radial ">
