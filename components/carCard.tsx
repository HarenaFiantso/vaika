...
export default function CarCard({ car, isPinned }: CarCardProps) {
  ...
  return (
    <div className='dark:bg-gradient-radial group mx-auto h-fit w-full max-w-lg rounded-2xl border bg-white from-slate-700 to-slate-900 p-3 transition-all duration-150 ease-linear group-hover:scale-125 dark:border-slate-700/70 md:p-4 md:hover:shadow-lg'>
