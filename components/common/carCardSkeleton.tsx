export default function CarCardSkeleton() {
  return (
    <div
      className="dark:bg-gradient-radial group h-fit w-full max-w-lg animate-pulse rounded-2xl border bg-white from-slate-700 to-slate-900 p-3 transition-all duration-700 ease-linear dark:border-zinc-600 dark:text-slate-300 md:p-4 md:hover:border md:hover:shadow-lg">
      <div className="flex items-center justify-between">
        <h1
          className="h-3 w-28 max-w-[75%] truncate bg-gray-400 text-lg font-bold capitalize dark:bg-slate-900 md:text-xl"></h1>
